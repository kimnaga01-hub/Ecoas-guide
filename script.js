        ...
        if (found && found.target) {
            ...
            resultCard.innerHTML = `
                <div style="text-align: center; margin-bottom: 24px;">
                    <div style="width: 80px; height: 80px; background: linear-gradient(135deg, var(--success-color) 0%, #00a085 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; box-shadow: 0 4px 16px rgba(0, 184, 148, 0.3);">
                        <span style="font-size: 2.5rem;">✓</span>
                    </div>
                    <h3 style="font-size: 1.8rem; color: var(--success-color); margin-bottom: 12px; font-weight: 700;">재활용 의무 대상</h3>
                    <p style="font-size: 1.1rem; color: var(--text-color); margin-bottom: 8px;">
                        <strong>"${productSearch.value}"</strong>은(는) 재활용 의무 대상 제품입니다.
                    </p>
                    <p style="font-size: 0.95rem; color: var(--text-light);">
                        ${found.category}에 해당합니다.
                    </p>
                </div>
                <div style="background: linear-gradient(135deg, #e8f5e9 0%, #ffffff 100%); padding: 24px; border-radius: var(--radius-md); border-left: 4px solid var(--success-color); margin-top: 24px;">
                    <p style="margin: 0; color: var(--text-color); line-height: 1.8;">
                        <strong>의무 사항:</strong> 이 제품을 제조·수입·판매하는 사업자는 재활용 의무를 이행하고, 매년 4월 15일까지 전년도 실적을 신고해야 합니다.
                    </p>
                </div>
            `;
            ...
            resultCard.innerHTML = `
                <div style="text-align: center; margin-bottom: 24px;">
                    <div style="width: 80px; height: 80px; background: linear-gradient(135deg, var(--warning-color) 0%, #f57c00 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; box-shadow: 0 4px 16px rgba(253, 203, 110, 0.3);">
                        <span style="font-size: 2.5rem;">✗</span>
                    </div>
                    <h3 style="font-size: 1.8rem; color: #f57c00; margin-bottom: 12px; font-weight: 700;">재활용 의무 비대상</h3>
                    <p style="font-size: 1.1rem; color: var(--text-color); margin-bottom: 8px;">
                        <strong>"${productSearch.value}"</strong>은(는) 시행령 별표 3에 명시되지 않은 제품입니다.
                    </p>
                    <p style="font-size: 0.95rem; color: var(--text-light);">
                        재활용 의무 대상이 아닐 수 있습니다.
                    </p>
                </div>
                <div style="background: linear-gradient(135deg, #fff3e0 0%, #ffffff 100%); padding: 24px; border-radius: var(--radius-md); border-left: 4px solid var(--warning-color); margin-top: 24px;">
                    <p style="margin: 0; color: var(--text-color); line-height: 1.8;">
                        <strong>참고:</strong> 정확한 판단을 위해서는 제품의 세부 분류를 확인하시거나, 한국환경공단(1544-1234)에 문의하시기 바랍니다.
                    </p>
                </div>
            `;
            resultArea.style.display = 'block';
